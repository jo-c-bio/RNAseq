...
# args[1] <- "VRN2_RNA_seq_data_Untreated_vs_Treated/cWT_vs_vWT_0FC.csv" 
# args[2] <- "VRN2_RNA_seq_data_Untreated_vs_Treated/cPRT6_vs_vPRT6_0FC.csv" 
...
#filter for only those GO terms with >10 genes in them 
